insert into globe_bank.pages (id, subject_id, menu_name, position, visible, content)
values  (1, 1, 'Globe Bank', 1, 1, '<div id="hero-image">
...
'),
        (14, 4, 'Financing', 1, 1, '<div id="hero-image">
...
'),
        (15, 4, 'Investments', 2, 1, '<div id="hero-image">
...
'),
        (16, 4, 'Treasury Services', 3, 1, '<div id="hero-image">
